...
/*Tabela que informa nome, código de países. Essa tabela contém uma chave primária (id_pais_pk), uma chave estrangeira (id_pais_fk) e nome dos paises.*/
...
/*Tabela do tipo 1:N. Contém o código de indentificação e nome de cada região cadastrada.*/
...
/*Tabela de localizações, contém os endereços de diversos escritórios e facilidades da empresa. Não armazena endereços de clientes.*/
...
/*Esta tabela reserva informações de identificação (id_departamento, nome, id_localização, id_gerente) dos departamentos da empresa.*/
...
/*Tabela que armazena informações dos funcionários da empresa.*/
...
/*Tabela de gerente com chave primária estrangeira para a tabela funcionarios.*/
...
/*Essa tabela armazena o histórico de cargos do funcionário. Novas linhas serão adicionadas caso houver mudança de departamento dentro de um cargo ou vice-versa.*/
...
/*Nesta parte no código, iremos alterar algumas propriedades em determinadas tabelas transformando-as em chaves estrangeiras.*/
